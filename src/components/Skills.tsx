        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-8">
          {categories.map(([category, skillList], catIndex) => (
            <motion.div
              ...
              className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl hover:shadow-violet-500/5 transition-all"
            >
