        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative">
              <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center shadow-2xl shadow-violet-500/20">
