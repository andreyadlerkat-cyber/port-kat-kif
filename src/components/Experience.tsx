    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 sm:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-violet-500 via-purple-500 to-indigo-500 opacity-20" />
          ...
          <div className="space-y-8">
            {data.map((item, i) => {
              ...
              return (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-2 sm:left-6 top-8 w-4 h-4 rounded-full bg-gradient-to-r from-violet-500 to-indigo-500 border-4 border-white dark:border-gray-900 shadow-md z-10" />

                  <div className="group p-6 sm:p-8 rounded-3xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 hover:border-violet-200 dark:hover:border-violet-700/50 hover:shadow-xl hover:shadow-violet-500/5 transition-all">
                    <div className="flex flex-wrap items-center gap-3 mb-3">
                      <span className="px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 text-xs font-semibold">
                        {period}
                      </span>
                    </div>
